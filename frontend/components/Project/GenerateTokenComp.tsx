            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <div className=' flex flex-col gap-3'>
                        ...
                        <span>Check <a target='_blank' className='underline' href = "https://switchr.hashnode.space/default-guide/accessing-flags-through-rest-api">Docs</a></span>
                        <br />
                        ...
                        } className='p-2 bg-secondary  rounded-lg w-full overflow-auto whitespace-pre-wrap'>
                        </textarea>
                    </div>
