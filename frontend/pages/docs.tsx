  ...
  return (
    <>
        ...
        <div className='max-w-[1200px] py-[6rem] w-full mx-auto'>
            ...
            <div className='text-primary/70 mt-12 text-xl flex flex-col gap-3'>
                <p>The following procedures can be followed once a project is created and some flags are added in it</p>
                <p><span className='font-bold'>Step 1</span>. Login and open the project whose keys you wish to access and the click on <Badge>Access</Badge> button on the project page.</p>
